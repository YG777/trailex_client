...
class WatchlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watchlist" do
    assert_difference('Watchlist.count') do
      post watchlists_url, params: { watchlist: { movie_id: @watchlist.movie_id, user_id: @watchlist.user_id } }, as: :json
    end
  ...
  test "should update watchlist" do
    patch watchlist_url(@watchlist), params: { watchlist: { movie_id: @watchlist.movie_id, user_id: @watchlist.user_id } }, as: :json
    assert_response 200
  end
