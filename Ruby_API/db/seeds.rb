...
Comment.create(user_id: 1, movie_id: 211672, body: "Greater than citizen kane")
Comment.create(user_id: 2, movie_id: 211672, body: "Greater than citizen kane")
Comment.create(user_id: 3, movie_id: 211672, body: "Greater than citizen kane")
Comment.create(user_id: 1, movie_id: 211672, body: "Greater than citizen kane")
Comment.create(user_id: 1, movie_id: 211672, body: "Greater than citizen kane")
